...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        self.element_is_visible(self.locators.FULL_NAME).send_keys("Bldo")
        self.element_is_visible(self.locators.EMAIL).send_keys('bldo@gmail.com')
        self.element_is_visible(self.locators.CURRENT_ADDRESS).send_keys('aaaa bbbb')
        self.element_is_visible(self.locators.PERMANENT_ADDRESS).send_keys('bbb aaa')
